...
let restaurants = [
  {
    ...
    image:
      "https://video-images.vice.com/articles/590647db9ac0f921f03ed8d9/lede/1493583856927-mcf_halloween_017.jpeg?crop=1xw:0.8439609902475619xh;center,center&resize=1200:*",
    cuisine_type: "Asian",
    operating_hours: {
  ...
  },
  {
    ...
    image:
      "https://media-cdn.tripadvisor.com/media/photo-s/17/07/cd/40/the-colony-and-vodka.jpg",
    cuisine_type: "Pizza",
    operating_hours: {
      Monday: "5:30 pm - 11:00 pm",
  ...
  },
  {
    ...
    image:
      "https://media-cdn.tripadvisor.com/media/photo-s/06/da/d6/de/kang-hodong-baekjeong.jpg",
    cuisine_type: "Asian",
    operating_hours: {
  ...
  },
  {
    ...
    image:
      "https://www.livingfla.com/wp-content/uploads/2019/04/katz-1-500.jpg",
  ...
  },
  {
    ...
    image:
      "https://c8.alamy.com/compes/dp9a5f/robertas-pizza-restaurant-en-east-williamsburg-de-brooklyn-dp9a5f.jpg",
    cuisine_type: "Pizza",
    operating_hours: {
  ...
  },
  {
    ...
    image:
      "https://es.nycgo.com/images/venues/6326/hometownbbq_redhook_brooklyn_nyc_kengoodman_hometownbbq-153-3__x_large.jpg",
    cuisine_type: "American",
    operating_hours: {
      Monday: "Closed",
  ...
  },
  {
    ...
    image:
      "https://i.pinimg.com/474x/47/b1/d3/47b1d3175589f19f58a35cfcd78b3e73--city-restaurants-mexican-restaurants.jpg",
...
let restaurant = restaurants.map(el => ({
  ...
  photograph: el.photograph,
  location: {
    adress: el.adress,
    coordinates: [el.latlng.lat, el.latlng.lng]
  },
  image: el.image,
